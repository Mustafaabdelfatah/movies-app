                    ...
                    <div class="col-md-4 text-white">
                        ...
                        @auth
                            <a href="#" class="btn btn-primary text-capitalize movie__fav-btn">
                                            <span class="fa fa-heart movie__fav-icon movie-{{ $movie->id }} {{ $movie->is_favored ? 'heart-shape' : 'fa fa-heart-o' }}"
                    ...
                    <div class="movie p-0">
                        ...
                        <div class="movie__details text-white">
                            ...
                            <div class="d-flex movie__cta">
                                ...
                                @auth
                                    <i class=" {{ $related_movie->is_favored ? 'heart-shape' : 'fa fa-heart-o'}} fa-1x align-self-center movie__fav-icon movie-{{ $related_movie->id }}"
